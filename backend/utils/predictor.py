...
class CollegePredictor:
    ...
    def _load_college_data(self) -> List[Dict]:
            ...
            try:
                with open(file_path, 'r', encoding='utf-8') as f:
                    ...
                    if isinstance(data, list):
                        return self._engineering_colleges_only(data)
        ...
        return self._engineering_colleges_only(self._get_sample_colleges())

    def _engineering_colleges_only(self, colleges: List[Dict]) -> List[Dict]:
        """Keep the predictor focused on Tamil Nadu engineering colleges."""
        return [
            college for college in colleges
            if college.get('stream', '').upper() == 'ENGINEERING'
        ]
    ...
    def calculate_cutoff(
        ...
        """
        Calculate the Tamil Nadu engineering cutoff out of 200.

        Formula:
        - Mathematics: actual score out of 100.
        - Physics: score divided by 2, max 50.
        - Chemistry: score divided by 2, max 50.
        - Total: Mathematics + (Physics / 2) + (Chemistry / 2).
        """
    ...
    def match_colleges(self, cutoff_score: float, community: str, stream: str) -> Dict:
        ...
        return {
            'safe': safe_colleges,
            'borderline': borderline_colleges,
            'dream': dream_colleges,
...
class ChatbotAssistant:
    ...
    def _handle_cutoff_query(self, message: str) -> str:
        ...
        • Mathematics: actual score out of 100
        • Physics: score ÷ 2 (maximum 50)
        • Chemistry: score ÷ 2 (maximum 50)
        • Total Engineering Cutoff: Maths + Physics/2 + Chemistry/2 = 200
        • Example: 90 + (80 ÷ 2) + (70 ÷ 2) = 165.00 / 200
    ...
    def _handle_college_query(self, message: str) -> str:
        ...
        Use the predictor tool above to find your personalized engineering college matches!
        """
    ...
    def _handle_stream_query(self, message: str) -> str:
        """Handle questions about engineering college availability."""
        stats = self.predictor.get_statistics()
        engineering_count = stats.get('streams', {}).get('ENGINEERING', 0)
        return f"📚 **Engineering Colleges:** {engineering_count} Tamil Nadu engineering college entries are available in the predictor."
    ...
    def _handle_default(self, message: str) -> str:
        ...
        • 📚 **Engineering colleges available**
          Example: "Engineering colleges"

        💡 **Quick Tip:** Use the Predictor tool above for personalized engineering college matching based on your marks and category!
